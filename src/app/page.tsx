...
/*
I think there is a bug in the job history tab, as every time I want to remove an image from one of the projects, all the images are removed. Then I try to upload the photos again and I realize the images are being added one after the other, no deletion happened, so now I have 16 duplicate photos when I only want to show 4
Unable to delete project's images on the "Work History" tab. Now I have 16 duplicate photos when I only want to show 4.
*/
